...
def get_sd_startfk_conf(**kwargs):
    try:
        ...
        pass
    try:
        sd_conf_path = kwargs.get("sd_startfk_config")
        with open(sd_conf_path, "r") as f:
            obj = json.loads(f.read())
            if kwargs.get("sd_startfk_path_relative_to_config"):
...
def is_img_created_by_comfyui_with_startfk_gen_info(img: Image):
...
def read_sd_startfk_gen_info_from_image(image: Image, path="") -> str:
    """
