...
from scripts.iib.tool import read_sd_startfk_gen_info_from_image
            ...
            with gr.Column():
                ...
                def img_update_func():
                    try:
                        ...
                        img = Image.open(path)
                        info = read_sd_startfk_gen_info_from_image(img, path)
                        return img, info
...
def on_app_started(_: gr.Blocks, app: FastAPI) -> None:
    # 第一个参数是SD-startfk传进来的gr.Blocks，但是不需要使用
