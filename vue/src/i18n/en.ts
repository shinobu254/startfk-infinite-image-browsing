...
export const en: IIBI18nMap = {
  ...
  'tauriLaunchConf.readSdStartfkConfigTitle': 'Read Stable Diffusion Config',
  'tauriLaunchConf.readSdStartfkConfigDescription':
    'If you have installed sd-startfk and this extension, it is recommended to use this option to directly read the configuration and share data.',
  'tauriLaunchConf.selectSdStartfkFolder': 'Click to select the SD-startfk folder',
