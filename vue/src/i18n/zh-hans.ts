export const zhHans = {
  ...
  fileSize: '文件大小',
  selectAll: '全选',
  'tauriLaunchConf.readSdStartfkConfigTitle': '读取Stable Diffusion 的配置',
  'tauriLaunchConf.readSdStartfkConfigDescription':
    '如果你已经安装sd-startfk，且在sd-startfk内安装了本拓展，推荐直接使用这个，将直接读取配置并且数据共享',
  'tauriLaunchConf.selectSdStartfkFolder': '点击选择SD-startfk的文件夹',
