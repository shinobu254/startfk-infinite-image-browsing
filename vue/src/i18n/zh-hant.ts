...
export const zhHant: IIBI18nMap = {
  ...
  fileSize: '文件大小',
  selectAll: '全選',
  'tauriLaunchConf.readSdStartfkConfigTitle': '讀取Stable Diffusion 的配置',
  'tauriLaunchConf.readSdStartfkConfigDescription':
    '如果你已經安裝sd-startfk,且在sd-startfk內安裝了本拓展,推薦直接使用這個,將直接讀取配置並且數據共享',
  'tauriLaunchConf.selectSdStartfkFolder': '點擊選擇SD-startfk的文件夾',
